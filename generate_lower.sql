...
(
 ...
 FOREIGN KEY(`master`)  REFERENCES `user` (`mail`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE FUNCTION deckUpdater(_id int, _user VARCHAR(100), _name varchar(50), _school varchar(50), _degree varchar(50), _public bit, _color VARCHAR(7)) returns int DETERMINISTIC
BEGIN
